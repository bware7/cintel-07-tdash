...
with ui.sidebar(title="Dashboard Controls"):
    ...
    with ui.div(class_="resource-links", style="display: flex; flex-direction: column; gap: 10px;"):
        ui.a(
            {"class": "nav-link", "style": "display: flex; align-items: center; gap: 8px;"},
            icon_svg("github", "brands"),
            "Source Code",
